...
- (void)createViews
{
    ...
    //Firas Update
    UILabel* titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(labelInset, 20.0, 200.0, LOCATIONBAR_HEIGHT)];
    titleLabel.hidden = NO;

    if ([titleLabel respondsToSelector:NSSelectorFromString(@"setMinimumScaleFactor:")]) {
        [titleLabel setValue:@(10.0/[UIFont labelFontSize]) forKey:@"minimumScaleFactor"];
    } else if ([titleLabel respondsToSelector:NSSelectorFromString(@"setMinimumFontSize:")]) {
